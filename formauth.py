...
"QPushButton:pressed { background: white; }")
        ...
        self.naming = QtWidgets.QLabel(self.groupBox_2)
        self.naming.setGeometry(QtCore.QRect(36, 130, 71, 20))
        self.naming.setStyleSheet("color: white;")
        self.naming.setText("")
        self.naming.setObjectName("naming")
        self.photo = QtWidgets.QPushButton(self.groupBox_2)
        self.photo.setGeometry(QtCore.QRect(130, 130, 101, 23))
...
"QPushButton:pressed { background: white; }")
        ...
        self.error.setGeometry(QtCore.QRect(16, 50, 231, 20))
